...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 1:
            // Music
            self.showViewController(viewController: UINavigationController.self, storyboardId: "PointsNavID")
        case 2:
            // Movies
            self.showViewController(viewController: UINavigationController.self, storyboardId: "RankingNavID")
        case 3:
            // Books
            self.showViewController(viewController: UINavigationController.self, storyboardId: "StatisticsNavID")
        case 4:
            // Profile
            self.showViewController(viewController: UINavigationController.self, storyboardId: "FixtureNavID")
        case 5:
            // Settings
            self.showViewController(viewController: UINavigationController.self, storyboardId: "SettingsNavID")
        case 6:
            // Like us on facebook
            let safariVC = SFSafariViewController(url: URL(string: "https://www.facebook.com/kamil.delekta.3/")!)
